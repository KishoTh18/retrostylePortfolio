  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-24 pb-16">
      ...
      <motion.div 
        ...
        style={{
          background: 'conic-gradient(from 0deg, #00bfff, #1e90ff, #00ffff, #4169e1, #00bfff)',
          filter: 'blur(8px)',
          opacity: 0.4
        }}
        animate={{
      ...
      <motion.div 
        className="absolute top-40 right-32 w-16 h-16 rounded-full"
        style={{
          background: 'conic-gradient(from 180deg, #ffd700, #ff8c00, #ffa500, #ffb347, #ffd700)',
          filter: 'blur(6px)',
          opacity: 0.5
        }}
        animate={{
      ...
      <motion.div 
        className="absolute bottom-32 left-40 w-20 h-20 rounded-full"
        style={{
      ...
      <div className="container mx-auto px-6 text-center z-10 relative max-w-6xl">
        {/* Main Hero Container with Glass Effect */}
        <motion.div
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-orange-500/10 rounded-3xl blur-3xl scale-110"></div>
          
          {/* Main Content Container */}
<div
  className="relative rounded-3xl p-12 md:p-16 min-h-[700px] flex flex-col justify-center"
  style={{
...
>
  <h1 className="text-6xl md:text-9xl font-black leading-[1.2] text-center">
<motion.span
  className="text-gradient-developer inline-block text-6xl md:text-7xl"
...
>
  ...
  <motion.div
    className="relative mb-16 inline-block mt-8"
  ...
  >
    <div className="relative w-72 h-72 mx-auto mb-8">
      ...
      >
        <div className="w-full h-full bg-gray-900/80 rounded-full"></div>
      </motion.div>
      ...
      <motion.div
        ...
        style={{
          background:
            'conic-gradient(from 180deg, #ffd700, #ff8c00, #ffa500, #ffb347, #ffd700)',
          padding: '2px',
          borderRadius: '50%'
        }}
      >
      ...
      >
        <img
          src={profileImage}
          alt="Pathmanathan Krishogaran - Professional Portrait"
          className="w-full h-full object-cover transition-transform duration-700 hover:scale-110"
          style={{ filter: 'contrast(1.1) brightness(1.05)' }}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-blue-600/10 via-transparent to-yellow-400/10"></div>
      ...
      />
              ...
              {/* Enhanced Subtitle with Icons and Animation */}
              <motion.div 
              ...
              >
                <motion.div 
                  className="flex items-center gap-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 px-4 py-2 rounded-full backdrop-blur-sm border border-blue-400/30"
                ...
                <motion.div 
                  className="flex items-center gap-3 bg-gradient-to-r from-cyan-500/20 to-teal-500/20 px-4 py-2 rounded-full backdrop-blur-sm border border-cyan-400/30"
                  whileHover={{ scale: 1.05, backgroundColor: "rgba(0, 255, 255, 0.1)" }}
                  transition={{ duration: 0.2 }}
                >
                  <motion.i 
                    className="fas fa-code text-2xl text-cyan-400"
                ...
                <motion.div 
                  className="flex items-center gap-3 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 px-4 py-2 rounded-full backdrop-blur-sm border border-yellow-400/30"
                  whileHover={{ scale: 1.05, backgroundColor: "rgba(255, 215, 0, 0.1)" }}
                  transition={{ duration: 0.2 }}
                >
                  <motion.i 
                    className="fas fa-microphone text-2xl text-yellow-400"
                    animate={{ y: [0, -5, 0] }}
            ...
            >
              ...
              >
                Transforming ideas into <motion.span 
                  className="text-gradient-developer font-bold"
                  whileHover={{ scale: 1.1 }}
                >digital solutions</motion.span> and 
                inspiring minds through <motion.span 
                  className="text-gradient-speaker font-bold"
                  whileHover={{ scale: 1.1 }}
                >powerful conversations</motion.span>
              </motion.p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <motion.button 
                  ...
                  whileHover={{ 
                    scale: 1.08,
                    boxShadow: '0 20px 40px rgba(102, 126, 234, 0.6), 0 0 0 1px rgba(255, 255, 255, 0.2)'
                  }}
                  whileTap={{ scale: 0.95 }}
